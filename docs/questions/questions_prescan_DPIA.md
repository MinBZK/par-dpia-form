...
| 0.2 |   Beschrijving van de verwerking | open_text |  | prescanModelId: 1; DPIA: 2.1 |
| 0.3 |   Doel gegevensverwerking | open_text |  | prescanModelId: 2; DPIA: 6.1 |
| 0.4 |   Wat is de grondslag voor de verwerking? | select_option | Toestemming betrokkene; Noodzakelijk voor overeenkomst; Wettelijke plicht; Vitaal belang; Taak van algemeen belang; Gerechtvaardigd belang | prescanModelId: 3; DPIA: 12.1.1 |
...
| 0.5.3 |     Welke vorm van cloud betreft het? | radio_option | Public cloud; Private cloud; Hybrid | Show if 0.5.1; prescanModelId: 5 |
| 0.5.4 |     Gaat het om materieel public cloudgebruik voor de primaire taak? | radio_option | True; False | Show if 0.5.1; prescanModelId: 6 |
...
| 1.1.3 |     Specificeer | open_text |  | Show if 1.1.2 |
| 1.2 |   Bijzondere persoonsgegevens | task_group |  |  |
| 1.2.1 |     Gaat het systeem bijzondere persoonsgegevens verwerken? | radio_option | True; False | prescanModelId: 8; DPIA: 13.1.1 |
...
| 1.5.4 |     Wat is de bewaartermijn van de gegevens? | select_option | Aantal jaren; Jaar; Minder dan 1 maand; Minder dan 1 week; Minder dan 24 uur | prescanModelId: 11.c; DPIA: 11.1.1.4 |
| 1.6 |   Zijn de volgende gebruikersgroepen betrokken bij de verwerking? | task_group |  | prescanModelId: 12 |
| 1.6.1 |     Afnemers van de dienst? Bijvoorbeeld burgers die een dienst van de overheid afnamen. | radio_option | True; False |  |
| 1.6.2 |     Afnemers van de informatie? Bijvoorbeeld (collega)overheidsorganan die informatie uit de applicatie of het proces halen? | radio_option | True; False |  |
...
| 2.1.2 |     Waar is het hoofdkantoor van de cloudprovider gevestigd? | radio_option | Binnen EER; Buiten EER | Show if 2.1.1; prescanModelId: 14; DPIA: 9.1.1 |
...
| 6.1.1 |     Wordt er gebruik gemaakt van een algoritme? | radio_option | True; False | prescanModelId: G; DPIA: 5 |
