...
| 0.2 |   Beschrijving van de verwerking | open_text |  | prescanModelId: 1; DPIA: [{'id': '1.1', 'type': 'one-to-one'}] |
| 0.3 |   Doel gegevensverwerking | open_text |  | prescanModelId: 2; DPIA: [{'id': '5.1.1', 'type': 'one-to-many'}] |
...
| 1.2.1 |     Gaat het systeem bijzondere persoonsgegevens verwerken? | radio_option | True; False | prescanModelId: 8; DPIA: [{'id': '12.1.1', 'type': 'pre-fill'}] |
