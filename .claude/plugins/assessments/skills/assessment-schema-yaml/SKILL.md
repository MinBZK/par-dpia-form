...
description: Use when editing assessment YAML sources in sources/, asking about the assessment schema structure, adding tasks/fields to dpia.yaml or prescan.yaml, or working with dependencies, calculations, or references in assessment definitions.
version: 0.1.0
---

# Assessment Schema YAML

Guide for editing YAML assessment sources (`sources/dpia.yaml`, `sources/prescan.yaml`) that conform to `schemas/assessment-definition.v1.schema.json`.
